          ...
          <v-stepper-items>
            ...
            <v-stepper-content step="2">
              ...
              <template v-else>
                ...
                <v-alert v-for="(error, index) in dat.errors" :key="index" :value="true" type="error" dismissible>{{ error }}</v-alert>
  ...
  methods: {
    ...
    async getDevices() {
      try {
        ...
        this.dat = JSON.parse(res.data)
        //this.variable = JSON.parse(res.data.devices) 
        
        //console.log(res.data.devices[1])
